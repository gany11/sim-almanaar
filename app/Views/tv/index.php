    ...
    */
    ...
    <div class="h-screen w-screen grid grid-rows-[minmax(0,1fr)_auto_44px] bg-slate-50">
        ...
        <div class="min-h-0 min-w-0 grid grid-cols-[70%_30%] portrait:flex portrait:flex-col">
            ...
            <main class="min-h-0 min-w-0 grid grid-rows-[57px_minmax(0,1fr)_126px] gap-[9px] p-[14px] pr-[7px] portrait:pr-[14px] portrait:flex-1">

                <header class="min-h-[69px] flex items-center gap-[12px] px-[11px] py-[6px] flex-wrap">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <h1 class="m-0 text-[clamp(18px,1.5vw,26px)] font-extrabold leading-tight text-slate-800">
                            Masjid Al-Manaar
                        </h1>

                        <p class="mt-1 text-[clamp(9px,0.68vw,13px)] font-medium text-slate-500">
                            <?= esc($alamatMasjid ?? 'Slipi, Jakarta Barat') ?>
                        </p>

                    </div>

                    <div class="flex-shrink-0 min-w-[195px] flex flex-col items-end justify-center pl-[15px] border-l border-slate-200">

                        <div
                            id="tv-header-date"
                            class="text-[clamp(12px,0.94vw,18px)] font-extrabold leading-tight text-slate-700 whitespace-nowrap">
                            -
                        </div>

                        <div
                            id="tv-header-hijriah"
                            class="mt-1 text-[clamp(11px,0.79vw,15px)] font-semibold leading-tight text-slate-500 whitespace-nowrap">
                            <?= esc($sholat['hijriah'] ?? '-') ?>
                        </div>
                ...
                <section class="relative min-h-0 min-w-0 overflow-hidden rounded-[15px] bg-white border border-slate-200 shadow-[0_8px_24px_rgba(15,23,42,0.06)]">
                    ...
                    <div
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <!-- ============ SLIDE: AGENDA (judul + 2 kolom / slide) ============ -->
                            ...
                            <?php foreach ($agendaChunks as $chunk): ?>
                                ...
                                <div class="swiper-slide">
                                    <div class="w-full h-full flex flex-col gap-[10px] p-[23px]">
                                        ...
                                        <div class="flex-1 min-h-0 grid grid-cols-2 gap-[14px]">
                                        ...
                                        <?php foreach ($chunk as $agenda): ?>
                                            ...
                                            */
                                            ...
                                            <article class="min-w-0 min-h-0 flex flex-col justify-center p-[18px] rounded-[14px] bg-slate-50 border border-slate-200<?= $cardSpanClass ?>">
                            ...
                            <!-- ============ SLIDE: SALDO (judul + grid 2x2 / slide) ============ -->
                    ...
                    <div
                        id="adzan-countdown"
                        class="hidden absolute inset-0 z-20 flex items-center justify-center p-[23px] bg-white">

                        <div class="w-full max-w-[540px] flex flex-col items-center justify-center text-center [animation:tv-blink_1s_linear_infinite]">

                            <div class="mb-1.5 text-[clamp(11px,1vw,17px)] font-extrabold tracking-[0.12em] text-slate-500">
                                WAKTUNYA ADZAN
                            </div>

                            <div
                                id="adzan-prayer"
                                class="text-[clamp(32px,3.75vw,65px)] font-black leading-none text-blue-700">
                                -
                            </div>
                    ...
                    <div
                        ...
                        <div class="w-full max-w-[540px] flex flex-col items-center justify-center text-center">
                            ...
                            <div
                                id="iqamah-prayer"
                                class="mb-2 text-[clamp(32px,3.75vw,65px)] font-black leading-none text-blue-700">
                                -
                            </div>

                            <div
                                id="iqamah-time"
                                class="text-[clamp(42px,5.25vw,90px)] font-black leading-none tracking-[0.04em] tabular-nums text-slate-900">
                                00:00
                            </div>

                            <div
                                id="iqamah-message"
                                class="mt-[13px] text-[clamp(10px,0.75vw,15px)] font-medium text-slate-500">
                ...
                <section class="min-h-0 min-w-0 overflow-hidden rounded-[17px] bg-white border border-slate-200 shadow-[0_8px_24px_rgba(15,23,42,0.06)]">
            ...
            <aside class="min-h-0 min-w-0 grid grid-rows-[0.85fr_1.15fr_1fr] gap-[9px] p-[14px] pl-[7px] portrait:grid-rows-none portrait:grid-cols-3 portrait:h-[135px] portrait:pl-[14px] portrait:pt-0">
                ...
                <section class="min-h-0 min-w-0 flex flex-col items-center justify-center p-[12px] rounded-[18px] bg-slate-50 border border-slate-200 shadow-[0_8px_24px_rgba(15,23,42,0.06)]">
                    ...
                    <div class="flex items-baseline justify-center text-[clamp(36px,3.75vw,66px)] font-black tracking-wide leading-[0.95] tabular-nums text-blue-700">
                ...
                <section class="min-h-0 min-w-0 overflow-hidden bg-white border border-slate-200 rounded-[18px] shadow-[0_8px_24px_rgba(15,23,42,0.06)]">
                    ...
                    <div class="h-full grid grid-cols-[42%_58%] gap-[12px] p-[12px]">
                ...
                <section class="min-h-0 min-w-0 flex flex-col items-center justify-center text-center p-[14px] rounded-[18px] bg-gradient-to-br from-blue-50 to-white border border-blue-200 shadow-[0_8px_24px_rgba(37,99,235,0.08)]">

                    <div
                        id="tv-countdown-label"
                        class="text-[clamp(9px,1vw,14px)] font-bold text-slate-500">
                        Memuat...
                    </div>

                    <div
                        id="tv-countdown-prayer"
                        class="text-[clamp(17px,1.28vw,26px)] font-black text-blue-700">
                        -
                    </div>

                    <div
                        id="tv-countdown-status"
                        class="mt-1 text-[clamp(9px,0.64vw,12px)] text-slate-600">

                    </div>

                    <div
                        id="tv-countdown-time"
                        class="mt-[9px] text-[clamp(24px,1.95vw,39px)] font-black leading-none tracking-[0.04em] tabular-nums text-slate-900">
                        00:00:00
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            let lastIqamahWarningPrayer = null;
            ...
            function updateIqamah(now) {
                ...
                // ==========================================
                // 3 DETIK TERAKHIR IQAMAH
                // ==========================================
                if (
                    active.remaining <= 4000 &&
                    active.remaining > 0 &&
                    lastIqamahWarningPrayer !== active.prayer
                ) {
                    ...
                    adzanAudio.play()
                        .then(() => {
                            console.log(
                                '[IQAMAH] Bunyi 4 detik terakhir:',
                                active.prayer
                            );
                        })
                        .catch(error => {
                            console.warn(
                                '[IQAMAH] Bunyi gagal diputar:',
                                error
                            );
                        });
                }
