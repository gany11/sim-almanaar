    ...
    <div class="bg-white border-b border-gray-100 mb-10">
        <div class="max-w-7xl mx-auto px-4 py-12">
            ...
            <div class="mb-8 text-center">
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">ARTIKEL</h1>
                <p class="text-gray-500 mt-1 italic">Menambah wawasan dan ilmu melalui tulisan-tulisan bermanfaat.</p>
            </div>
        </div>
    </div>
