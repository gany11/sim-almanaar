...
<div class="bg-gray-50 min-h-screen pb-20">
    <div class="bg-white border-b border-gray-100 mb-10">
        <div class="max-w-7xl mx-auto px-4 py-12">
            ...
            <div class="mb-8 text-center">
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">BERITA</h1>
                <p class="text-gray-500 mt-1 italic">Informasi terkini mengenai kegiatan dan kabar Masjid Al-Manaar.</p>
            </div>
        </div>
    </div>
