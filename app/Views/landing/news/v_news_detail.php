        ...
        <nav class="flex mb-8 text-sm font-medium">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li class="flex items-center text-gray-400">
                    ...
                    <a href="<?= base_url('berita') ?>" class="hover:text-blue-600">Berita</a>
                </li>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <main class="lg:col-span-8">
                <header class="mb-8">
                    ...
                    <div class="flex flex-wrap items-center gap-6 text-sm text-gray-500 border-y border-gray-100 py-4">
                        <div class="flex items-center gap-2">
                            <i data-lucide="calendar" class="w-4 h-4 text-blue-600"></i>
                            <span><?= format_indo($news['created_at'], 'full') ?></span>
                        </div>
                        <div class="flex items-center gap-2">
                            <i data-lucide="user" class="w-4 h-4 text-blue-600"></i>
                            <span><?= $news['nama_admin'] ?? 'Admin Masjid' ?></span>
                        </div>
                        <div class="flex items-center gap-2">
                            <i data-lucide="tag" class="w-4 h-4 text-blue-600"></i>
                            <span class="bg-blue-50 text-blue-700 px-2 py-0.5 rounded text-[10px] font-bold uppercase">Berita</span>
                        </div>
                    </div>
                </header>
                ...
                <div class="mt-12 pt-8 border-t border-gray-100 flex justify-between items-center">
                    <p class="text-sm text-gray-400 italic">Bagikan berita ini:</p>
                    <div class="flex gap-4">                        
                        <a href="https://api.whatsapp.com/send?text=<?= urlencode("Assalamualaikum, mari baca berita terbaru dari Masjid Al-Manaar: \n\n*" . $news['judul'] . "*\n\nSelengkapnya di: " . $current_url) ?>" 
