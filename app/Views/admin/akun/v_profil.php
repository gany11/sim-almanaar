...
<div class="container mx-auto pb-10 max-w-5xl">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-8">
        ...
        <form action="<?= base_url('admin/profil/update') ?>" method="post" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <?= csrf_field() ?>
            <div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        ...
        <form action="<?= base_url('admin/profil/update-password') ?>" method="post" class="space-y-6">
            <?= csrf_field() ?>
