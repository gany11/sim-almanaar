<?php if (empty($berita)): ?>
    <tr>
        <td colspan="4" class="px-6 py-10 text-center text-gray-400 italic">Data berita tidak ditemukan.</td>
    </tr>
<?php else: ?>
        ...
        <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-all">
            <td class="px-6 py-4">
                <div class="flex items-center gap-4">
                    <img src="<?= base_url('uploads/berita/' . $row['sampul']) ?>" 
            ...
            <td class="px-6 py-4">
                <div class="flex justify-center gap-2">
                    <a href="<?= base_url('admin/news/edit/' . $row['id_publikasi']) ?>" 
